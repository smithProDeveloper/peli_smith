...
export async function getMoviesTopRatedQuery(page: string, language: LanguageType, with_genres: string): Promise<ResponseServer<UpcomingMoviesResponse>> {
    const config = {
        method: 'get',
        maxBodyLength: Infinity,
        url: `${urlApi}/api/peli_smith/movies_top_rated?page=${page}&language=${language}&with_genres=${with_genres}`,
        headers: {
