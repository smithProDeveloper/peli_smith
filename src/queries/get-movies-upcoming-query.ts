...
export async function getMoviesUpcomingQuery(page: string, language: LanguageType, with_genres: string): Promise<ResponseServer<UpcomingMoviesResponse>> {
    const config = {
        method: 'get',
        maxBodyLength: Infinity,
        url: `${urlApi}/api/peli_smith/movies_upcoming?page=${page}&language=${language}&with_genres=${with_genres}`,
        headers: {
